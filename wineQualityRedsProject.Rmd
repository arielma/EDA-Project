...
The dataset has 1599 wine samples and each sample has 12 attributes accociated. I have created a column named total.acidity to represent the sum of different type of acids. I have also created a factor column quality.factor based on numberic column Quality. All attributes and their measured unit are listed below:  
...
I have created a new variable quality.factor to transform the numeric data into a categorical data.  
...
ggplotly(ggplot(data = redwine, aes(x = chlorides, y = quality)) +
...
ggplot(data = redwine, aes(x = sulphates, y = alcohol, color = quality.factor)) + 
...
ggplot(data = redwine, aes(x = citric.acid, y = alcohol, color = quality.factor)) + 
  geom_point(alpha = 1/4) +
  geom_smooth(method = "lm",se = FALSE, size= 1) +
  scale_color_brewer(type='seq',
                     guide=guide_legend(title='Quality')
